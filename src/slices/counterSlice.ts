...
import { CounterState, initialCounterState} from "../models/counter";
import { LOADING_STATUS } from "../models/common";
...
export const counterSlice = createSlice({
  ...
  extraReducers: (builder: ActionReducerMapBuilder<CounterState>) => {
    builder
      .addCase(incrementAsync.pending, (state: Draft<CounterState>) => {
        state.status = LOADING_STATUS.Loading;
      })
      .addCase(incrementAsync.fulfilled, (state: Draft<CounterState>, action) => {
